...
import { Image as ImageIcon,  Image, UploadCloud, ArrowLeft, ShieldAlert  } from "lucide-react";
    ...
    <div className="flex-1 w-full px-margin-mobile md:px-margin-desktop py-8 lg:py-12">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-10 text-center flex flex-col items-center">
          ...
          <h1 className="text-3xl lg:text-4xl font-bold text-heading-navy mb-4">WebP Converter</h1>
