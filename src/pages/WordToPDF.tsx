...
import { FileText, UploadCloud, ArrowLeft, ShieldAlert } from "lucide-react";
    ...
    <div className="flex-1 w-full px-margin-mobile md:px-margin-desktop py-8 lg:py-12">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <h3 className="text-xl font-semibold text-heading-navy mb-2">Upload your Word document here</h3>
