...
import { Image as ImageIcon,  Minimize, UploadCloud, ArrowLeft, ShieldAlert  } from "lucide-react";
    ...
    <div className="flex-1 w-full px-margin-mobile md:px-margin-desktop py-8 lg:py-12">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-10 text-center flex flex-col items-center">
          ...
          <h1 className="text-3xl lg:text-4xl font-bold text-heading-navy mb-4">Image Compressor</h1>
          <p className="text-lg text-on-surface-variant max-w-2xl">
            Compress JPG, PNG, SVG, and GIFs securely.
          </p>
        </div>
