      ...
      <div className="max-w-4xl mx-auto w-full flex flex-col">
        ...
        <div className="mb-10">
          ...
          <p className="text-on-surface-variant max-w-2xl">
            Write tailored cover letters instantly.
          </p>
        </div>
        ...
        <div className="bg-surface-container-lowest border border-border-slate rounded-2xl overflow-hidden shadow-sm">
          <div className="p-6 md:p-8 border-b border-border-slate">
            <form onSubmit={handleSubmit} className="flex flex-col gap-6">
              <div className="flex flex-col gap-2"><label className="text-sm font-semibold text-heading-navy">Job Title</label><input type="text" className="w-full bg-surface border border-border-slate rounded-lg px-4 py-2.5 text-base text-heading-navy outline-none focus:border-primary transition-colors" placeholder="Enter job title..." required /></div><div className="flex flex-col gap-2"><label className="text-sm font-semibold text-heading-navy">Company Name</label><input type="text" className="w-full bg-surface border border-border-slate rounded-lg px-4 py-2.5 text-base text-heading-navy outline-none focus:border-primary transition-colors" placeholder="Enter company name..." required /></div>
