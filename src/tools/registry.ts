...
export type ToolExecution = "local" | "ai-text" | "ai-file";
...
export const tools: ToolDefinition[] = [
  { id: "word-to-pdf", category: "PDF Tools", name: "Word to PDF", path: "/pdf-tools/word-to-pdf", description: "Convert DOCX documents to PDF.", execution: "local", icon: FileText, component: page(() => import("../pages/WordToPDF"), "WordToPDF") },
  ...
  { id: "pdf-to-word", category: "PDF Tools", name: "PDF to Word", path: "/pdf-tools/pdf-to-word", description: "Create an editable DOCX from PDF text.", execution: "local", icon: FileText, component: page(() => import("../pages/PDFToWord"), "PDFToWord") },
  ...
  { id: "pdf-summarizer", category: "AI Tools", name: "AI PDF Summarizer", path: "/ai-tools/pdf-summarizer", description: "Summarize a PDF with explicit cloud consent.", execution: "ai-file", icon: Brain, component: page(() => import("../pages/PDFSummarizer"), "PDFSummarizer") },
  { id: "chat-with-pdf", category: "AI Tools", name: "Chat with PDF", path: "/ai-tools/chat-with-pdf", description: "Ask questions about an uploaded PDF.", execution: "ai-file", icon: Brain, component: page(() => import("../pages/ChatWithPDF"), "ChatWithPDF") },
  ...
  { id: "resume-analyzer", category: "AI Tools", name: "Resume Analyzer", path: "/ai-tools/resume-analyzer", description: "Analyze a PDF or text resume with AI.", execution: "ai-file", icon: Brain, component: page(() => import("../pages/ResumeAnalyzer"), "ResumeAnalyzer") },
